...
GET `https://external-platofrm.com/api/v1/courses`

The API needs to follow the structure:
...
```json
{
    ...
    "current_page": 2,
    "last_page": 2,
    "next_page_url": "https://external-platofrm.com/api/v1/courses?page=3",
    "prev_page_url": "https://external-platofrm.com/api/v1/courses?page=1",
    "from": 1,
    "to": 10,
    "data" : [
        {
            ...
            "thumbnail": "https://external-platofrm.com/storage/app/medias/courses/thumbnail/181120100340-hairdresser-3572053_1280.jpg",
            ...
            "url": "https://external-platofrm.com/courses/123456",
            "meta" : {
                "duration": 150,
